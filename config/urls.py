...
urlpatterns = [
    ...
    path('verificar-cambio-email/', views.verificar_cambio_email, name='verificar_cambio_email'),
    path('reenviar-codigo-email/', views.reenviar_codigo_email, name='reenviar_codigo_email'),
